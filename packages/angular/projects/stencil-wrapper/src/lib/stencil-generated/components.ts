...
@ProxyCmp({
  inputs: ['accessibilityIconAlt', 'accessibilityIconHref', 'accessibilityIconId', 'accessibilityIconSrc', 'accessibilityIconSrcDark', 'accessibilityIconTooltip', 'aiIconAlt', 'aiIconHref', 'aiIconId', 'aiIconSrc', 'aiIconSrcDark', 'aiIconTooltip', 'aria_label', 'chatIconAlt', 'chatIconHref', 'chatIconId', 'chatIconSrc', 'chatIconSrcDark', 'chatIconTooltip', 'colorTheme', 'dubaiaeIconAlt', 'dubaiaeIconHref', 'dubaiaeIconId', 'dubaiaeIconSmallSrc', 'dubaiaeIconSrc', 'dubaiaeIconSrcDark', 'dubaiaeIconTooltip', 'firstLogoAlt', 'firstLogoHref', 'firstLogoSrc', 'firstLogoTooltip', 'happinessIconAlt', 'happinessIconHref', 'happinessIconId', 'happinessIconSrc', 'happinessIconSrcDark', 'happinessIconTooltip', 'hideMiddleSection', 'locationButtonHref', 'locationButtonIcon', 'locationButtonText', 'locationLogoSrc', 'middleLink', 'moreIcon', 'moreIconFamily', 'more_button_label', 'newsButtonHref', 'newsButtonIcon', 'newsButtonSrc', 'newsButtonText', 'rightLink', 'secondLogoAlt', 'secondLogoHref', 'secondLogoSrc', 'secondLogoTooltip', 'servicesIconAlt', 'servicesIconHref', 'servicesIconId', 'servicesIconSrc', 'servicesIconSrcDark', 'servicesIconText', 'servicesIconTooltip', 'thirdLogoAlt', 'thirdLogoHref', 'thirdLogoSrc', 'thirdLogoTooltip']
})
@Component({
