...
@ProxyCmp({
  inputs: ['accessibilityIconAlt', 'accessibilityIconHref', 'accessibilityIconId', 'accessibilityIconSrc', 'accessibilityIconSrcDark', 'accessibilityIconTooltip', 'aiIconAlt', 'aiIconHref', 'aiIconId', 'aiIconSrc', 'aiIconSrcDark', 'aiIconTooltip', 'aria_label', 'chatIconAlt', 'chatIconHref', 'chatIconId', 'chatIconSrc', 'chatIconSrcDark', 'chatIconTooltip', 'colorTheme', 'firstLogoAlt', 'firstLogoHref', 'firstLogoSrc', 'firstLogoTooltip', 'happinessIconAlt', 'happinessIconHref', 'happinessIconId', 'happinessIconSrc', 'happinessIconSrcDark', 'happinessIconTooltip', 'hideMiddleSection', 'locationButtonHref', 'locationButtonIcon', 'locationButtonText', 'locationLogoSrc', 'newsButtonHref', 'newsButtonIcon', 'newsButtonSrc', 'newsButtonText', 'secondLogoAlt', 'secondLogoHref', 'secondLogoSrc', 'secondLogoTooltip', 'servicesIconAlt', 'servicesIconHref', 'servicesIconId', 'servicesIconSrc', 'servicesIconSrcDark', 'servicesIconText', 'servicesIconTooltip', 'thirdLogoAlt', 'thirdLogoHref', 'thirdLogoSrc', 'thirdLogoTooltip']
})
@Component({
