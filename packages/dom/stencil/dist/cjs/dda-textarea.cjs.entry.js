...
const DdaTextarea = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd0bb6567ab98ba883829d3516d3cf69d82cae7a6' }, index.h("div", { key: 'a1e08f65edc242579bb57122c67be1b426231b22', class: textareaClass }, this.label && index.h("label", { key: 'eb8051391170626ded478fed00ddf6a172a0993f', htmlFor: this.input_id, class: "dda-input-label" }, this.label), this.enable_rich_editor ? (index.h("div", { id: "editor", class: "dda-richeditor-field" })) : (index.h("textarea", { id: this.input_id, name: this.textarea_name, "aria-label": this.aria_label, placeholder: this.placeholder, value: this.value, onInput: (event) => this.handleInput(event), class: "dda-input-field dda-input-textarea", maxLength: this.max_characters })), this.helper_text && (index.h("div", { key: 'd5446212e8bea676e7a824f902a7efe898256a92', class: "dda-helper-text" }, index.h("span", { key: '3206ccc5c6795c6de730d856403394c208fd5e84', class: "dda-flex dda-align-center dda-gap-2" }, index.h("i", { key: '74b8d3d7e16b0b636b5b4b2c15201c35bc6c17ba', class: "material-icons  material-symbols-outlined" }, "info"), " ", this.helper_text), index.h("span", { key: '224f922fd07e0a904437049fabbe01d02250f6ff', class: "dda-letter-count" }, this.characterCount, " / ", this.max_characters))), this.error_message && (index.h("div", { key: '2b8b7eededc81a5be97ea7925ccbe8f21a3e4f42', class: "dda-error-message" }, index.h("span", { key: 'af58e34909d92f3d454ee137f1758024c695ef29', class: "dda-flex dda-align-center dda-gap-2" }, index.h("i", { key: '0c1789a75bc703ab07e00da1ff706c60ae13d17e', class: "material-icons  material-symbols-outlined" }, "info"), " ", this.error_message), index.h("span", { key: '6a8ad00442fe3c132aa8168629c624bed751a58b', class: "dda-letter-count" }, this.characterCount, " / ", this.max_characters))))));
    }
