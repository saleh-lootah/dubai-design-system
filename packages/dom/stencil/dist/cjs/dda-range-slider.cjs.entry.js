...
const DdaRangeSlider = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9f56d7653eae6dd59536c17a653c1ebfb78dca6c' }, index.h("div", { key: '386fc45f0974eac81b998064998e565e45c46552', class: `dda-range-slider-container dda-tooltip-${this.tooltip_position} ${this.custom_class} ${this.component_mode}` }, index.h("div", { key: 'ab33c978e089b8f7ae4234bdecd93b5f5752daa1', class: "dda-range-slider" }, index.h("div", { key: '3c6ae60ab82b4c7da6c4661932de479f618406c8', class: "dda-range-slider-track", style: {
                left: `${this.getPercentage(this.min_value)}%`,
                right: `${100 - this.getPercentage(this.max_value)}%`,
            } }, index.h("span", { key: '392598b4196a8e59ffec60815991ed71026e5028', class: "min-label" }, this.min_value, "%"), index.h("span", { key: '81555b4c924da122363e24549e1c3d8e204b3a57', class: "max-label" }, this.max_value, "%")), index.h("label", { key: '4121dd3f9e55f32f098e93396e28d72de8017b32', htmlFor: this.left_input_id }, index.h("input", { key: 'f69117a97159ea29dcf9a69f0dc6720b29a993a6', id: this.left_input_id, name: this.left_input_name, "aria-label": this.left_aria_label, type: "range", min: this.min, max: this.max, step: this.step, value: this.min_value, onInput: (event) => this.handleMinChange(event), class: "dda-range-slider-input", style: { zIndex: `${this.min_value > this.max - this.min_value ? 5 : 3}` } })), index.h("label", { key: '0bb8b51ee1eb62cf7fd3a01203a4f8b7698fed65', htmlFor: this.right_input_id }, index.h("input", { key: 'd78cff142eef24e08b4abee2aef2101af23c8796', id: this.right_input_id, name: this.right_input_name, "aria-label": this.right_aria_label, type: "range", min: this.min, max: this.max, step: this.step, value: this.max_value, onInput: (event) => this.handleMaxChange(event), class: "dda-range-slider-input", style: { zIndex: `${this.max_value < this.max - this.min_value ? 5 : 3}` } }))))));
    }
};
