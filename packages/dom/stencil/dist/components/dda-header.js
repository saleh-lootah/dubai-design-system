...
import { d as defineCustomElement$5 } from './p-964fd419.js';
import { d as defineCustomElement$4 } from './p-a40d5e88.js';
import { d as defineCustomElement$3 } from './p-abc1068c.js';
...
const DdaHeader$1 = /*@__PURE__*/ proxyCustomElement(class DdaHeader extends H {
    ...
    static get style() { return DdaHeaderStyle0; }
        ...
        "loginIcon": [1, "login-icon"],
        "loginText": [1, "login-text"],
        "languageText": [1, "language-text"],
        "hamburgerMenuButtonName": [1, "hamburger-menu-button-name"],
        "accessibilityButtonName": [1, "accessibility-button-name"],
        "searchButtonName": [1, "search-button-name"],
        "searchInputName": [1, "search-input-name"],
        "languageButtonName": [1, "language-button-name"],
        "closeMenuButtonName": [1, "close-menu-button-name"],
        "closeAccessibilityButtonName": [1, "close-accessibility-button-name"],
        "closeSidebarButtonName": [1, "close-sidebar-button-name"],
        "toggleAccessibilityButtonName": [1, "toggle-accessibility-button-name"],
        "isMenuOpen": [32],
        "isSubMenuOpen": [32],
