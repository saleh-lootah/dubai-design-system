...
| `input_id`             | `input_id`             | `id` of the amount input. Also used for the label `for` and the helper and error text ids. Optional: an id is generated when it is not set. | `string` | `undefined`         |
...
| `label`                | `label`                | Visible label text, linked to the amount input through `input_id` (or a generated id).                                                      | `string` | `undefined`         |
