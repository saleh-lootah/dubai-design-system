...
| `current_page`              | `current_page`              | Selected page, counted from 1. Kept between 1 and `total_pages`; updates when the user changes the page.                 | `number`                                                                                               | `1`               |
...
| `total_pages`               | `total_pages`               | Number of pages. Values below 1 become 1.                                                                                | `number`                                                                                               | `8`               |
