...
| `input_id`           | `input_id`           | `id` of the textarea or editor. Also used for the label and the helper and error text ids.                 | `string`  | `undefined` |
...
| `label`              | `label`              | Visible label text, linked to the field through `input_id`.                                                | `string`  | `undefined` |
