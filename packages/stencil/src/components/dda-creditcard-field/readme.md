...
| `helper_text`     | `helper_text`     | Helper text shown below the input. Linked by `aria-describedby`.                                                                               | `string`  | `undefined`   |
| `input_id`        | `input_id`        | `id` of the inner `<input>`. Also used to link the label, helper text and error message. Optional: an id is generated when it is not set.      | `string`  | `undefined`   |
...
| `label`           | `label`           | Label text shown above the input. Linked to the input through `input_id` (or a generated id).                                                  | `string`  | `undefined`   |
