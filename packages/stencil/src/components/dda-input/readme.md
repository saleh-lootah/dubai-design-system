...
| `autocomplete`    | `autocomplete`    | `autocomplete` token of the inner `<input>`, e.g. `name`, `email` or `tel`. Set it on fields that ask about the user (WCAG 1.3.5).                                      | `string` | `undefined` |
