...
| `input_id`        | `input_id`        | `id` of the inner `<input>`. Also used for the label `for` and the helper and error text ids.                                                                           | `string` | `undefined` |
...
| `label`           | `label`           | Visible label text, linked to the input through `input_id`.                                                                                                             | `string` | `undefined` |
