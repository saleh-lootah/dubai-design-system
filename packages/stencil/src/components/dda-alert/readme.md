...
| `close_button_label` | `close_button_label` | Accessible name of the close button, read by screen readers instead of the icon ligature.                                              | `string`                                      | `'Close'`   |
...
| `heading_level`      | `heading_level`      | Heading level (1–6) of the title; pick the level that fits the page outline.                                                           | `number`                                      | `4`         |
